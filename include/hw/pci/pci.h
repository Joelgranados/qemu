...
#define QEMU_PCIE_CAP_ATS_BITNR 13
    QEMU_PCIE_CAP_ATS = (1 << QEMU_PCIE_CAP_ATS_BITNR),
#define QEMU_PCIE_CAP_PRI_BITNR 14
    QEMU_PCIE_CAP_PRI = (1 << QEMU_PCIE_CAP_PRI_BITNR),
};
